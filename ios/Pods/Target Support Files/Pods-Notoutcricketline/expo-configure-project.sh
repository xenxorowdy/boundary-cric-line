...
with_node \
  ...
  --target "/Users/riyamjain/Downloads/cricket-live-line-newfish/ios/Pods/Target Support Files/Pods-Notoutcricketline/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-av" "expo-background-fetch" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-keep-awake" "expo-linear-gradient" "expo-network" "expo-router" "expo-speech" "expo-system-ui"
